#ifndef YDS_SDL_DEVICE_H
#define YDS_SDL_DEVICE_H

#include "yds_device.h"
#include <SDL.h>
#include "yds_window.h"

class ysSDLDevice : public ysDevice {
    
    ~ysSDLDevice();

public:
    static constexpr DeviceAPI SubclassID = DeviceAPI::SDL;
